...
//            HibernatingRhinos.Profiler.Appender.NHibernate.NHibernateProfiler.Initialize();
        ...
        {
            var allConstituents = searchServiceImpl.Search(firstName, lastName, email, phone, occupationName, occupationDescription, instituteName, instituteLocation, qualification, yearOfGradutation, address, state, city, country, postcode, preferedName);
