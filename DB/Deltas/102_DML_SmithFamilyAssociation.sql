...
UPDATE [dbo].[Associations] set ReciprocalId = 4 where Id = 3;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 3 where Id = 4;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 6 where Id = 5;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 5 where Id = 6;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 8 where Id = 7;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 7 where Id = 8;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 10 where Id = 9;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 9 where Id = 10;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 12 where Id = 11;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 11 where Id = 12;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 13 where Id = 14;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 14 where Id = 13;
GO
...
UPDATE [dbo].[Associations] set ReciprocalId = 16 where Id = 15;
GO

UPDATE [dbo].[Associations] set ReciprocalId = 15 where Id = 16;
GO
